...
VALID_ACTIONS = {
    ...
    "browser": {
        ...
        "next_tab", "prev_tab", "goto_tab", "go_back", "go_forward", "refresh",
    ...
    "office": {
        "word.open", "word.new", "word.save", "word.save_as", "word.close",
        "word.print", "word.bold", "word.italic", "word.underline",
        "word.align", "word.font_size", "word.heading",
        "word.bullet_list", "word.numbered_list",
        "word.insert_table", "word.find_replace", "word.spell_check",
        "word.word_count", "word.new_page",
        "word.select_paragraph", "word.increase_font", "word.decrease_font",
        "excel.open", "excel.new", "excel.save", "excel.goto_cell",
        "excel.auto_sum", "excel.create_chart", "excel.filter", "excel.sort",
        "excel.freeze_panes", "excel.new_sheet", "excel.find_replace",
        "excel.pivot_table",
        "ppt.open", "ppt.new", "ppt.save", "ppt.new_slide",
        "ppt.delete_slide", "ppt.next_slide", "ppt.prev_slide",
        "ppt.start_slideshow", "ppt.end_slideshow",
        "ppt.insert_image", "ppt.duplicate_slide",
    },
    "files": {
